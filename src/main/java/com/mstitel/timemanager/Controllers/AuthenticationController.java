...
import com.mstitel.timemanager.Services.ConfirmationTokenService;
import com.mstitel.timemanager.Services.EmailSender;
import com.mstitel.timemanager.DTOs.LoginDTO;
import com.mstitel.timemanager.DTOs.SignUpDTO;
...
import com.mstitel.timemanager.Services.AuthenticationService;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpDTO signUpDTO){
        ...
        matcher = specialCharacterPattern.matcher(signUpDTO.getPassword());
        if (matcher.find()){
        ...
        for (String emailDomain : allowedEmailDomains){
            if (signUpDTO.getEmail().toLowerCase().endsWith(emailDomain)){
                isValidDomain = true;
                break;
            }
        }
        ...
        emailSender.send(signUpDTO.getEmail(),
                buildEmail(signUpDTO.getUsername(), link) );
